...
#define INL_LEN 5   /* maximum number of digits for IL USE TO PREVENT OVERFLOW WHEN CONVERTING!!!!! Using SHRT_MAX is platform dependant, and therefor
may allow greater than the allowed spec for platypus language on certain machines */
